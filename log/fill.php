...
<head>
    ...
    <style>
       body{
        background-color: rgba(87, 68, 118, 0.1); /* Purple color with 25% opacity */
       }
        .container {
        ...
        .text-bg-primary{
            background-color: rgba(87, 68, 118, 0.7);
         border-radius: 8px;
         border: none;
         color: white;
        }
        .text-bg-primary:hover{
            cursor: pointer;
            background-color: rgba(64, 81, 137, 0.5); /* Blue color with 10% opacity */
        }
        input{
            opacity: 0.7;
        }
